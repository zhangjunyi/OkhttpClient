...
public abstract class OkHttpRequest {
	...
	protected OkHttpRequest(String url, String tag, Map<String, String> params,
			Map<String, String> headers,boolean isStore,CacheControl  cacheControl,ReQuestCache reQuestCache) {
	...
	public static class Builder {
		...
		public Builder url(String url) {
		 ...
		 public Builder ReQuestCache(ReQuestCache reQuestCache) {
		      this.reQuestCache = reQuestCache;
		      return this;
		    }
		...
		public <T> T get(Class<T> clazz) throws IOException {
			OkHttpRequest request = new OkHttpGetRequest(url, tag, params,
					headers,isStore,cacheControl,reQuestCache);
